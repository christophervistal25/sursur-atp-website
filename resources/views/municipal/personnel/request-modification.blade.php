...
<div class=" flex items-center h-10 mt-5">
    <h2 class="text-lg font-medium truncate mr-5">
        Edit {{ $personnel->lastname }}'s Information
    </h2>
...
@else
    @if($errors->has('message'))
        <div class="intro-y col-span-12 md:col-span-6">
        <div class="box">
            <div class="flex flex-col lg:flex-row items-center p-5 bg-theme-6 rounded">
                <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                    <p class="font-medium text-white">{{ $errors->first('message') }}</p>
                </div>
            </div>
        </div>
    </div>
...
<div class=" box py-10 sm:py-20 mt-5">
    ...
    <form id="formAddNewPersonnel"
          method="POST"
          enctype="multipart/form-data"
          action="{{ route('request.to.admin', $personnel->id) }}">
        @csrf
        @method('PUT')
            ...
            <div class="intro-x grid grid-cols-12 gap-4 row-gap-5 mt-5 section" id="person-information">
                ...
                <div class=" col-span-12 sm:col-span-3">
                    ...
                    <div class="p-1 bg-white flex">
                        <input
                            ...
                            type="text" placeholder="e.g. Vistal" name="lastname" value="{{  old('lastname') ?? $personnel->lastname }}">
                    </div>
                ...
                <div class=" col-span-12 sm:col-span-3">
                    ...
                    <div class="p-1 bg-white flex">
                        <input
                            ...
                            type="text" placeholder="e.g. Platino" name="middlename" value="{{  old('middlename') ?? $personnel->middlename }}">
                    </div>
                ...
                <div class=" col-span-12 sm:col-span-3">
                    ...
                    <div class="p-1 bg-white flex">
                        <input placeholder="Enter Suffix"
                            ...
                            type="text" maxlength="3" placeholder="e.g. Jr" name="suffix" value="{{  old('suffix') ?? $personnel->suffix }}">
                    </div>
                </div>
                ...
                <div class=" col-span-12 sm:col-span-6">
                    ...
                    <div class="p-1 bg-white flex border {{ $errors->has('address') ? 'border-red-500' : '' }} rounded">
                        <textarea
                            placeholder="e.g. Purok Paradise 950"
                            class="p-1 px-2 appearance-none outline-none w-full text-gray-800"
                            rows="5"
                            name="address">{{ old('address') ?? $personnel->address }}
                        </textarea>
                    </div>
                ...
                <div class=" col-span-12 sm:col-span-6">
                    ...
                    <div class="p-1 bg-white flex ">
                        <select
                            ...
                            @else
                                <option
                                    {{ $personnel->civil_status == $status ? 'selected' : '' }}
                                    value="{{ $status }}">
                                    {{ $status }}
                                </option>
                            @endif
            ...
            <div class="intro-x grid grid-cols-12 gap-4 row-gap-5 mt-5 section hidden" id="login-information">
                <div class=" col-span-12 sm:col-span-4">
                    ...
                    <div class=" p-1 bg-white flex">
                        <input
                            ...
                            type="text" placeholder="Enter username" name="user[username]" value="{{ old('username') ?? $personnel->information->username }}">
                    </div>
                    <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">
                ...
                <div class=" col-span-12 sm:col-span-4">
                    ...
                    <div class="p-1 bg-white flex ">
                        <input
                            ...
                            type="password" name="user[password]" value="{{ old('password') }}" placeholder="Enter password">
                    </div>
                ...
                <div class=" col-span-12 sm:col-span-4">
                    ...
                    <div class="p-1 bg-white flex ">
                        <input
                            class="input border p-2 px-2 appearance-none outline-none w-full text-gray-800 border {{  $errors->has('password') ? 'border-red-500' : '' }}"
                            type="password" name="user[password_confirmation]" value="{{ old('password_confirmation') }}"
