                ...
                <div class="grid grid-cols mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        @if(Session::has('success'))
                            <div class="intro-y col-span-12 md:col-span-6 mb-2">
                                <div class="box">
                                    <div class="flex flex-col lg:flex-row items-center p-5 bg-theme-9 rounded">
                                        <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                                            <p class="font-medium text-white">Checker Successfully Added!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form  method="POST" action="{{ route('m-checker.store') }}" class="preview">
                                    @csrf
