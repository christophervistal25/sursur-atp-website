                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form method="POST" action="{{ route('checker.update', $checker->id) }}" class="preview">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <select class="select2 w-full input border" name="city" >
                                            @foreach($cities as $city)
                                                @if(old('city'))
                                                    <option {{ old('city') == $checker->municipal_code ? 'selected' : '' }} value="{{ $city->code }}">
                                                    {{ @$city->province->name }} - {{ $city->name }}
                                                </option>
                                                @else
                                                    <option {{ $city->code == $checker->municipal_code ? 'selected' : '' }} value="{{ $city->code }}">
                                                    {{ @$city->province->name }} - {{ $city->name }}
                                                </option>
                                                @endif
                                            @endforeach
