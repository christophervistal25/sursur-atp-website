...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
  ...
  <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <a href="{{  route('establishment.create') }}" class="button text-white bg-theme-1 shadow-md mr-2">Add New Establishment</a>
...
<!-- END: Datatable -->
  ...
  <script>
    ...
    let ROUTE = `${BASE_URL}admin/establishment/list`;
