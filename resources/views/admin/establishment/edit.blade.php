                            ...
                            <form method="POST" action="{{ route('establishment.update', $establishment->id) }}"
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $establishment->latitude  ?? 0.0 }}&{{ $establishment->longitude ?? 0.0 }}"
                                ...
                                <div class="flex flex-col md:flex-row mt-3">
                                    <div class="flex-1 flex flex-col md:flex-row">
                                        <div class="w-full flex-1 mr-2">
                                            City
                                            <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">*</span>
                                            <div class="{{ $errors->has('city')  ? 'border border-theme-6 rounded' : ''}}">
                                                <select
                                                    class="select2 w-full input border"
                                                    name="city" id="cities">
                                                    <option disabled>Select Province to show all city</option>
                                                    <option selected value="{{  $establishment->city_code }}">
                                                        {{  $establishment->city->name }}</option>
                                                </select>
                                            </div>
                                            <div class="text-xs text-theme-6">
                                                @if($errors->has('city'))
