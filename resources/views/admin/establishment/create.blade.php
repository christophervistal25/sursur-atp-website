                        ...
                        <div class="box">
                            <div class="flex flex-col lg:flex-row items-center p-5 bg-theme-9 rounded mb-2">
                                <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                                    <p class="font-medium text-white">Establishment added successfully</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('establishment.store') }}" class="preview">
                                        ...
                                        <div class="w-full flex-1">
                                            ...
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    type="text" placeholder="Gaisano Capital" aria-invalid="true"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        name="address" rows="5" placeholder="Cabrera St, Tandag, Surigao del Sur">{{ old('address') }}</textarea>
                                    <div class="text-xs text-theme-6">
                                ...
                                <div class="w-full mt-3">
                                    Province
                                    <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">*</span>
                                    <div class="{{ $errors->has('province') ? 'border border-theme-6 rounded' : '' }}">
                                ...
                                <div class="flex flex-col md:flex-row mt-3">
                                    <div class="flex-1 flex flex-col md:flex-row">
                                        <div class="w-full flex-1 mr-2">
                                            ...
                                            <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">*</span>
                                            <div
                                                class="{{ $errors->has('city') ? 'border border-theme-6 rounded' : '' }}">
                                                <select class="select2 w-full input border" name="city" id="cities">
