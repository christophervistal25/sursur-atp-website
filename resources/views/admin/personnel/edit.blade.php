    ...
    <div class="box">
        <div class="flex flex-col lg:flex-row items-center p-5 bg-theme-9 rounded">
            <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                <p class="font-medium mb-2 text-white">Personnel Updated Successfully!</p>
                ...
                <div class=" col-span-12 sm:col-span-4">
                    ...
                    <div class=" p-1 bg-white flex">
                        <input
                            ...
                            type="text" placeholder="Enter username" name="username" value="{{ old('username') ?? $personnel->information->username }}">
                    </div>
                    <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">
