...
@section('page-title', 'Edit ' . $admin->lastname . 's Information')
@section('content')
<div class="grid grid-cols-12 gap-6">
    <div class="col-span-12 xxl:col-span-12 grid grid-cols-12 gap-6">
        Edit {{ $admin->lastname }}'s
        <div class="col-span-12 mt-8">
            {{-- @include('templates.error') --}}
            <div class="intro-y flex items-center h-10">
                <h2 class="text-lg font-medium truncate mr-5">
                    Edit {{ $admin->lastname }}'s Information
                </h2>
                    ...
                    <div class="intro-y box">
                        ...
                        <div class="p-5" id="input">
                            <form method="POST" enctype="multipart/form-data"
                                action="{{ route('administrator.update', $admin->id) }}" class="preview">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="flex-1 flex flex-col md:flex-row">
                                        ...
                                        <div class="w-full flex-1 mx-2">
                                            ...
                                            <div class="p-1 bg-white flex border rounded">
                                                <input placeholder="e.g Jr"
                                                    class="p-1 px-2 appearance-none outline-none w-full text-gray-800"
                                                    type="text" maxlength="3" placeholder="e.g. Jr" name="suffix"
                                                    value="{{  old('suffix') ?? $admin->suffix }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text"
                                        class="input w-full border {{  $errors->has('username')  ? 'border-theme-6' : '' }}"
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="password"
                                        class="input w-full border {{  $errors->has('password')  ? 'border-theme-6' : '' }}"
                                        name="password">
                                    ...
                                    <div class="text-xs text-theme-1">
                                        Fill this field if you want to change the password of {{  $admin->username }}
                                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="password"
                                        class="input w-full border {{  $errors->has('password_confirmation')  ? 'border-theme-6' : '' }}"
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input type="text"
                                        class="input w-full border {{  $errors->has('phone_number')  ? 'border-theme-6' : '' }}"
                                        placeholder="+639193693499"
                                        value="{{ old('phone_number') ?? $admin->phone_number }}" name="phone_number">
                                    <div class="text-xs text-theme-6">
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input type="file"
                                        class="input w-full border {{  $errors->has('image')  ? 'border-theme-6' : '' }}"
                                        name="image">
                                    @if($errors->has('image'))
                                    <div class="text-xs text-theme-6">
                                        {{ $errors->first('image') }}
                                    ...
                                    @else
                                    <div class="text-xs text-theme-1">
                                        Attach image if you want to change the profile image of
                                        {{  Auth::user()->lastname }}
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="flex lg:justify-end mt-5">
                                    <button type="submit" class="button bg-theme-9 shadow text-white w-auto">Update
                                        {{ $admin->lastname }}'s Information</button>
                                </div>
                            </form>
                        </div>
                    </div>
