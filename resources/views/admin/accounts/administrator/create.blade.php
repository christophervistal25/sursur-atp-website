                    ...
                    <div class="intro-y box">
                        ...
                        <div class="p-5" id="input">
                            <form method="POST" enctype="multipart/form-data"
                                action="{{ route('administrator.store') }}" class="preview">
                                @csrf
                                <div class="flex flex-col md:flex-row border-b border-gray-200 pb-4 mb-4">
                                    <div class="flex-1 flex flex-col md:flex-row">
                                        <div class="w-full flex-1">
                                            <label>
                                                Firstname
                                                <span class="sm:ml-auto mt-1 sm:mt-0  text-red-600">*</span>
                                            </label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="username" value="{{ old('username') }}" placeholder="e.g. administrator">
                                    <div class=" text-theme-6">
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="+639193693499" value="{{  old('phone_number') }}"
                                        name="phone_number">
                                    <div class=" text-theme-6">
