                    ...
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <form action="{{ route('admin.auth.loginAdmin') }}" method="POST">
                            ...
                            <div class="intro-x mt-8">
                                ...
                                <input type="text" class="intro-x login__input input input--lg border border-gray-300 block mt-4 {{ $errors->has('message') ? 'border-theme-6' : '' }}" placeholder="Password" name="password">
                            </div>
